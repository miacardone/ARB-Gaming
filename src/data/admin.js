...
export const UPLOAD_HISTORY = [
  ...
  { id: 'up13', filename: 'player-protection-claims-w32.csv', uploadedAt: ago(1, 6), uploadedBy: USERS[2].email, rows: 64, accepted: 64, rejected: 0, status: 'Completed', note: null },
  ...
  { id: 'up10', filename: 'manual-coin-adjustments-july.csv', uploadedAt: ago(9), uploadedBy: USERS[4].email, rows: 6, accepted: 6, rejected: 0, status: 'Completed', note: null },
];
...
export const buildUploadSchema = (b = brand) => [
  ...
  { column: 'external_id', required: true, example: `${b.acquirers[0].slice(0, 3).toUpperCase()}-8834712`, note: 'Acquirer case number or claim reference' },
  ...
  { column: 'reason_code', required: true, example: '13.1', note: 'Scheme code, or claim reason for claims' },
  ...
  { column: 'order_id', required: true, example: `${b.numbering.orderPrefix}-38340681` },
...
export const WEBHOOK_TOPICS = [
  ...
  { id: 'alert.received', label: 'Early-warning alert received', description: 'A network alert landed ahead of any chargeback.' },
...
export const BULK_ACTION_HISTORY = [
  { id: 'ba3', name: 'Route overdue coin-credit failures to supervisor', runAt: ago(1, 2), runBy: CURRENT_USER.email, matched: 46, applied: 46, status: 'Completed' },
